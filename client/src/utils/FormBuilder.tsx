...
/**
 * Converts form data to an object with structure as template object but values of submitted form data object.
 * This is the decoding function for submitted data created by FormBuilder component.
